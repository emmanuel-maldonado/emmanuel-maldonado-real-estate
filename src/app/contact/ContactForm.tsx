...
export default function ContactForm() {
  ...
  return <form className="contact-form" onSubmit={submit}>
    ...
    <label>How can I help?<select name="interest" defaultValue="" required><option value="" disabled>Select one</option><option>Buying a home</option><option>Selling a home</option><option>Property management</option><option>Property ownership questions</option><option>Not sure yet</option></select></label>
